...
{
    public class LoginDialogFragment : AbstractDialogFragment<ILoginConfig>
    {
        #region Fields
        ...
        public LoginDialogFragment(ILoginConfig config)
            : base(config)
        {
        }

        public LoginDialogFragment(IntPtr handle, JniHandleOwnership transfer)
